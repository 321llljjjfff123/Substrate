...
/// Import the binance pallet.
pub use pallet_binance;
...
/// Configure the pallet-binance in pallets/template.
impl pallet_binance::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type AuthorityId = pallet_binance::crypto::TestAuthId;
}
